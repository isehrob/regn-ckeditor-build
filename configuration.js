window.CKeditorConfig = {
    ...
    toolbar: [
        { name: 'document', items: [ 'Print', 'PageBreak', 'Docprops', 'Templates' ] },
    ...
    extraPlugins: 'pastefromword,imageresizerowandcolumn,dialog,uploadimage,templates,bt_table,' +
      'tableresizerowandcolumn,ruler,lineheight,panelbutton,floatpanel,btquicktable,base64image,textindent',
